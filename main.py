...
img =pygame.image.load("eleon1.jpeg").convert()
...
while start:
    ...
    for (x,y,w,h) in faces:
        ...
        cv2.line(frame,(x,y1),(x1+30,y),(0,0,255),6)#bottom left
        cv2.line(frame,(x,y1),(x1,y+30),(0,0,255),6)
    ...
    text=font.render("Face Detection: {} Face Detected".format(len(faces)),True,(255,255,255)) #white color
